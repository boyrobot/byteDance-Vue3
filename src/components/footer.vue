<template>
  <div class="footer">
    <div class="footer-content-column">
      ...
      <p class="title">© 2012-2023 天问科技</p>
      <p class="title">京ICP备1202549号-3</p>
    </div>
    <div class="footer-content-column">
      <div class="title">联系我们</div>
      <p>邮箱：liuyuqi.gov@msn.cn</p>
      <p>微信：ab3255</p>
    </div>
    <div class="footer-content-column">
      <div class="title">企业合作</div>
      <p><a href="https://git.yoqi.me">芝舟开源</a></p>
    </div>
    <div class="footer-content-column">
      <div class="title">实时动态信息，请关注我们</div>
        ...
        <li class="contact-item toutiao">
          <svg width="33" height="32">
            <defs>
              ...
              <filter id="icon-toutiao_svg__c" width="428.1%" height="428.1%" x="-164.1%" y="-164.1%"
                filterUnits="objectBoundingBox">
                <feOffset dy="2" in="SourceAlpha" result="shadowOffsetOuter1" />
                <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation="12.5" />
                <feColorMatrix in="shadowBlurOuter1" result="shadowMatrixOuter1"
            ...
            <g fill="none" fill-rule="evenodd">
              ...
              <use fill="#1F2329" fill-rule="nonzero" transform="translate(-1229 -125)"
              ...
              <g transform="translate(.5)">
                ...
                <g filter="url(#icon-toutiao_svg__c)" mask="url(#icon-toutiao_svg__d)">
                  ...
                  <path fill="#DDD"
                    ...
                    mask="url(#icon-toutiao_svg__f)" />
                  <path fill="#FF373C" d="M32 25.297L0 27V7.703L32 6z" mask="url(#icon-toutiao_svg__f)" />
                  <path fill="#FFF"
                  ...
                  <path fill="#FFF"
                    ...
                    mask="url(#icon-toutiao_svg__f)" />
                  <path fill="#FFF" d="M17 11.954L18.815 13 21 9.79 19.003 9z" mask="url(#icon-toutiao_svg__f)" />
                </g>
              </g>
            </g>
          </svg>
